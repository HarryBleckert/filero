...
$string['memory_limit'] = 'PHP memory limit für die FILERO Archivierung. Bite beachten dass alle Dateien gemeinsam gestreamed werden. Speicherbedarf bis zu 2.5 x alle Dateien';
