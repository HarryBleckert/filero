...
$string['filero'] = 'Archiving';
$string['fileroenabled'] = 'Archiving of file submissions and feedback files';
$string['fileroenabled_help'] = 'Check activates legally assured archiving with FILERO';
